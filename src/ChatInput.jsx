...
const ChatInput = ({
  ...
  const handleSummarize = async () => {
    ...
    const textToSummarize = Array.isArray(messages) ? messages.join(" ") : messages;
    
    if (!textToSummarize || textToSummarize.length < 150) {
            ...
            <div>
              ...
              <div className="action-button">
                <div className="action-button-select">
                  ...
                  {textToSummarize && textToSummarize.length > 150 && summarizerAvailable && (
                    <button
